...
$select = mysqli_query($db, "SELECT * FROM control where ctr_usr_id='$usr_id'");

$row = mysqli_fetch_array($select);
$usr_spc_id = $row['ctr_spc_id'];
        ...
        <div class="col-xl-9 col-lg-10 col-md-12 col-sm-12 mx-auto">
            <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
				...
				<div class="col-xl-6 col-lg-6 col-md-12 mx-auto mb-4">
                    ...
                    <div class="col-12">
<?php if ($usr_spc_id != $spc_id) { ?>
			<a class="btn btn-primary btn-block" href="select-species.php?id=<?php echo $spc_id; ?>">Select</a>   
<?php } else { ?>
<a class="btn btn-primary btn-block" >Selected</a>
<?php }  ?>
        </div>
                    </form>
                </div>
