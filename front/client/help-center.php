...
$query_prbs = mysqli_query($db, "SELECT * FROM problems where prb_status in ('". $statuses ."') and prb_topic like '%$search_topic%' and prb_usr_id='$usr_id' order by prb_date ");
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="container mt-5">
    <div class="row tm-content-row">
		...
		<div class="col-12">
                  <a class="btn btn-primary btn-block" href="report-problem.php">Create a new thread for an issue</a>
                </div>
...
?>
   ...
   <tr>
       ...
       <td class="tm-product-name"><a href="help-center.php?id=<?php echo $row['prb_id'];?>"> 
	   <?php
    echo $row['prb_topic'] . " - " . $row['prb_date'];
?></td>
     </tr>
...
?>
  				<div class="form-group mb-3">
                                 <textarea id="answer" class="output-max <?php if($row_a['ans_admin']==0){ echo "client-ans"; } else { echo "admin-ans"; };?>" readonly> <?php echo $row_a['ans_text'];?></textarea>
                                    </div>
