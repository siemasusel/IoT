            ...
            <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
                <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12">
                        <form action="insrt_control.php" method="post" class="tm-edit-product-form">
                            ...
                            <div class="row">
                                <div class="form-group mb-3 col-xs-12 col-sm-6">
                                    ...
                                    <textarea name="mintmp" class="output"></textarea> 
                                </div>
                                <div class="form-group mb-3 col-xs-12 col-sm-6">
                                    <label
                                            for="maxtmp"
                                    ...
                                    <textarea name="maxtmp" class="output"></textarea> 
							...
							<div class="row">
                                <div class="form-group mb-3 col-xs-12 col-sm-6">
                                    ...
                                    <textarea name="minhmd" class="output"></textarea>
                                </div>
                                <div class="form-group mb-3 col-xs-12 col-sm-6">
                                    <label
                                            for="maxhmd"
                                    ...
                                    <textarea name="maxhmd" class="output"></textarea>
                                </div>
                            </div>
							<div class="row">
								<div class="form-group mb-3">
							...
							<div class="row">
                                ...
                                <div class="form-group mb-3 col-xs-12 col-sm-6">
                                    ...
                                    <textarea name="minph" class="output"></textarea>                                </div>
                                <div class="form-group mb-3 col-xs-12 col-sm-6">
                                    <label
                                            for="maxph"
                                    >Maximum
                                    </label>
                                    <textarea name="maxph" class="output"></textarea>
                                </div>
                            </div>
