...
<html lang="en">
  <head>
    ...
    <title>Registration in SMARTARRIUM</title>
    <link
      rel="stylesheet"
    ...
    <div class="container tm-mt-big tm-mb-big">
      <div class="row">
          ...
          <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
            <div class="row">
              <div class="col-12 text-center">
                <h2 class="tm-block-title mb-4">Register in SMARTARRIUM</h2>
              </div>
            </div>
            <div class="row mt-2">
              <div class="col-12">
		<form action="register.php" method="post" class="tm-login-form">
                  ...
                  <a class="mt-5 btn btn-primary btn-block text-uppercase" href="login.php">
