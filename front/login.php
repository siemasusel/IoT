...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($username_err) && empty($password_err)){
        ...
        $sql = "SELECT usr_id, usr_email, usr_password FROM users WHERE usr_email= ?";
...
<html lang="en">
  <head>
    ...
    <title>Login to SMARTARRIUM</title>
    <link
      rel="stylesheet"
          ...
          <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
            <div class="row">
              <div class="col-12 text-center">
                <h2 class="tm-block-title mb-4">Log in to SMARTARRIUM</h2>
              </div>
            </div>
            <div class="row mt-2">
              <div class="col-12">
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" class="tm-login-form">
                  ...
                  <a href="register.php" class="mt-5 btn btn-primary btn-block text-uppercase">
                    Sign up
                  </a>
                </form>
              </div>
