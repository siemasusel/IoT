    ...
    <div class="row">
        <div class="col-xl-9 col-lg-10 col-md-12 col-sm-12 mx-auto">
            <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
                <div class="row">
                    <div class="col-12">
                        <h2 class="tm-block-title d-inline-block">Edit Species</h2>
                    </div>
					<div class="col-12">
                        <a class="btn btn-primary btn-block" href="species.php?id=<?php echo $spc_id; ?>">Go back</a>
                    </div>
                </div>
			...
			<form action="update-species.php?id=<?php echo $spc_id; ?>" method="post" class="tm-edit-product-form">	
                  ...
                  <textarea name="mintmp" class="output"><?php echo $mintmp;?></textarea> 
                                </div>
                                <div class="form-group mb-3 col-xs-12 col-sm-6">
                                    <label
                                            for="maxtmp"
                                    ...
                                    <textarea name="maxtmp" class="output"><?php echo $maxtmp;?></textarea>
                                </div>
                            </div>
							<div class="row">
								<div class="form-group mb-3">
							...
							<div class="row">
                                <div class="form-group mb-3 col-xs-12 col-sm-6">
                                    ...
                                    <textarea name="minhmd" class="output"><?php echo $minhmd;?></textarea>
                                </div>
                                <div class="form-group mb-3 col-xs-12 col-sm-6">
                                    <label
                                            for="stock"
                                    ...
                                    <textarea name="maxhmd" class="output"><?php echo $maxhmd;?></textarea>
                                </div>
                            </div>
							<div class="row">
								<div class="form-group mb-3">
							...
							<div class="row">
                                ...
                                <div class="form-group mb-3 col-xs-12 col-sm-6">
                                    ...
                                    <textarea name="minph" class="output"><?php echo $minph;?></textarea>
                                </div>
                                <div class="form-group mb-3 col-xs-12 col-sm-6">
                                    <label
                                            for="stock"
                                    ...
                                    <textarea name="maxph" class="output"><?php echo $maxph;?></textarea>
                                </div>
                            </div>
