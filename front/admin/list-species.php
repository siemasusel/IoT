...
<form method="post" action="delete-species.php">
...
?>
   ...
   <tr>
       <th scope="row"><input type="checkbox" name="delete[]" value="<?php echo $row['spc_id'];?>"/></th>
       <td class="tm-product-name"><a href="/admin/species.php?id=<?php
    echo $row['spc_id'];
?>"> <?php
    echo $row['spc_name'];
?></td>
...
?>
                ...
                <!-- table container -->
 <input type="submit" value="Delete selected species" name="but_delete" class="btn btn-primary btn-block">
			   </form>	
			   <a
                        href="add-species.php"
                        class="btn btn-primary btn-block mb-3">Add new species</a>
